...
Требования к проекту php 7.4, mySQL 5.7

1. Выполнить установку пакетов командой composer i
2. Создать базу данных с именем slim_project, либо с другим именем и отредактировать конфиг в .env 
3. Создать пользователя webmaster с паролем webmaster, либо использовать другого пользователя для доступа к бд, отредактировать конфиг в .env
4. Выполнить миграции командой php console orm:schema-tool:create из директории bin
5. Выполнить команду php console fetch:trailers из директории bin
6. Для старта локального сервера команда php -S localhost:8888 -t public public/index.php из корневой директории проекта
